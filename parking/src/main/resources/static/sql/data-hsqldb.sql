...
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (1, 1, 1, 1, TIMESTAMP '2020-01-22 16:45:03', TIMESTAMP '2022-01-22 17:56:00', 3.33, '');
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (2, 1, 2, 2, TIMESTAMP '2020-01-23 16:43:00', TIMESTAMP '2022-01-22 17:59:00', 3.33, '');
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (3, 2, 3, 4, TIMESTAMP '2020-01-23 17:00:03', null, 3.33, '');
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
...
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (6, 2, 2, 1, TIMESTAMP '2020-02-05 12:40:03', TIMESTAMP '2020-02-05 14:04:00', 3.33, '');
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (7, 2, 4, 5, TIMESTAMP '2020-02-12 16:45:03', TIMESTAMP '2020-02-12 17:56:00', 3.33, '');
insert into registration (registration_id, customer_id, vehicle_id, slot_id, checkin_time, checkout_time, price, notes)
    values (8, 2, 2, 1, TIMESTAMP '2020-02-13 16:33:09', TIMESTAMP '2020-02-13 20:22:00', 3.33, '');